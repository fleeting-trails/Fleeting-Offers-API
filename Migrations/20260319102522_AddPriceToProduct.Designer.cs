...
namespace FleetingOffers.Migrations
{
    ...
    [Migration("20260319102522_AddPriceToProduct")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FleetingOffers.Module.Product.ProductAdditionalImageEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FleetingOffers.Module.Product.ProductCategoryEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FleetingOffers.Module.Product.ProductIndustryEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
                    ...
                    b.ToTable("ProductIndustries");
                });

            modelBuilder.Entity("FleetingOffers.Module.Product.ProductOwnerEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FleetingOffers.Module.Product.ProductTagEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FleetingOffers.Module.Product.ProductAdditionalImageEntity", b =>
                {
                    ...
                    b.HasOne("FleetingOffers.Module.Product.ProductEntity", null)
                        .WithMany("AdditionalImages")
            ...
            modelBuilder.Entity("FleetingOffers.Module.Product.ProductOwnerEntity", b =>
                {
                    b.HasOne("FleetingOffers.Module.Product.ProductEntity", "Product")
                        .WithMany("Owners")
